            ...
            <template v-slot:header>
              <div class="row">
                ...
                <div class="col-2 text-right">
                  <base-button type="primary" size="sm" icon="fa fa-plus" @click="goToCreate()" v-if="can('categories.store')">Add category</base-button>
                </div>
              </div>
                    ...
                    <template v-slot:default="row">
                      ...
                      <td class="text-right">
                        <base-dropdown class="dropdown" position="right">
                          ...
                          <template v-slot:default>
                            <router-link v-if="can('categories.update')" class="dropdown-item"
                                         :to="{ name: 'editCategories', params: { id: row.item.id }}">Edit
                            </router-link>
                            <a class="dropdown-item" v-if="can('categories.destroy')" @click="destroy(row.item)" href="#">Delete</a>
                          </template>
                        </base-dropdown>
                      </td>
                    </template>
